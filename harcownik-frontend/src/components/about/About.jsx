            ...
            <Col>
              <Card className="h-100">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text>
                    Odpowiada za rozwój aplikacji, utrzymanie jej oraz kwestie
                    związane z infrastrukturą.
                  </Card.Text>
                  <div className="mt-auto">
                    <Button
                      data-testid="Learn More Paweł"
                      variant="primary"
                      className="mt-auto"
                      href="https://pl-pl.facebook.com/people/Pawe%C5%82-Polski/pfbid0c17y1CUAhTfbuT7w9hnkAGRMtFWYS7eRURVCxBqZrezy11E1eX7nu5SxWGhCS1yel/"
                    >
                      Learn More
                    </Button>
                  </div>
            ...
            <Col>
              <Card className="h-100">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <div className="mt-auto">
                    <Button
                      data-testid="Learn More Michał"
                      variant="primary"
                      className="align-bottom"
                      href="https://pl-pl.facebook.com/michal.wlo.7"
                    >
                      Learn More
                    </Button>
                  </div>
            ...
            <Col>
              <Card className="h-100">
                ...
                <Card.Body className="d-flex flex-column">
                  ...
                  <Card.Text>
                    Odpowiada za rozwój aplikacji oraz kwestie związane z
                    organizacją zespołą (Scrum Master) oraz za finalny wygląd
                    aplikacji.
                  </Card.Text>
                  <div className="mt-auto">
                    <Button
                      data-testid="Learn More Kasia"
                      variant="primary"
                      className="align-bottom"
                      href="https://www.facebook.com/kasia.duszynska.52"
                    >
                      Learn More
                    </Button>
                  </div>
